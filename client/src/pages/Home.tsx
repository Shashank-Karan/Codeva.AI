          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-4 text-gray-300">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start space-x-3">
                      ...
                      <span><strong className="text-white">Smart Fixes:</strong> Get intelligent suggestions with detailed explanations</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2"></div>
                      <span><strong className="text-white">Code Quality:</strong> Improve performance, readability, and maintainability</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                      <span><strong className="text-white">Learning Mode:</strong> Understand why fixes work and prevent future issues</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="lg:order-1">
                <div className="bg-slate-900/60 rounded-2xl border border-slate-700/50 p-8 backdrop-blur-sm">
                  <div className="flex items-center justify-between mb-6">
                    <h4 className="text-xl font-bold text-white">Debug Preview</h4>
                    <div className="flex space-x-2">
                      <div className="w-3 h-3 bg-red-400 rounded-full"></div>
                      <div className="w-3 h-3 bg-yellow-400 rounded-full"></div>
                      <div className="w-3 h-3 bg-green-400 rounded-full"></div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-800/80 rounded-lg p-4">
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        <span className="text-red-300 text-sm font-mono">Error: Undefined variable</span>
                      </div>
                      <div className="flex items-center space-x-2 mb-3">
                        <div className="w-3 h-3 bg-yellow-500 rounded-full"></div>
                        <span className="text-yellow-300 text-sm font-mono">Warning: Unused import</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                        <span className="text-green-300 text-sm font-mono">Fixed: Added declaration</span>
                      </div>
                    </div>
                    <Link href="/debug">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/visualize" className="text-gray-400 hover:text-white transition-colors">Code Visualization</Link></li>
                <li><Link href="/debug" className="text-gray-400 hover:text-white transition-colors">AI Debugging</Link></li>
          ...
          <div className="border-t border-slate-700/30 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 CodeVis.ai. Transforming code understanding through AI visualization.
            </p>
          </div>
        </div>
      </footer>
